...
def unos_artikla(redni_broj):
    ...
    cijena = unos_pozitivnog_cijelog_broja(f'Unesite cijenu {redni_broj}. artikla: ')
    ...
    if tip_artikla == 1:
        kvadratura = unos_pozitivnog_cijelog_broja(f'Unesite kvadraturu {redni_broj}. stana: ')

        return Stan(kvadratura, naslov, opis, cijena)

    elif tip_artikla == 2:
        snaga = unos_pozitivnog_cijelog_broja(f'Unesite snagu {redni_broj}. auta: ')
